...
function updateData()
{
  ...
  hourZeroImg.src = `/src/images/${oneHourImg}.svg`
  hourOneImg.src = `/src/images/${oneHourImg}.svg`
  hourTwoImg.src = `/src/images/${twoHourImg}.svg`
  hourThreeImg.src = `/src/images/${threeHourImg}.svg`
  hourFourImg.src = `/src/images/${fourHourImg}.svg`
  hourFiveImg.src = `/src/images/${fiveHourImg}.svg`
  hour6Img.src = `/src/images/${hour6ImgSrc}.svg`
  hour7Img.src = `/src/images/${hour7ImgSrc}.svg`
  hour8Img.src = `/src/images/${hour8ImgSrc}.svg`
  hour9Img.src = `/src/images/${hour9ImgSrc}.svg`
  hour10Img.src = `/src/images/${hour10ImgSrc}.svg`
  hour11Img.src = `/src/images/${hour11ImgSrc}.svg`
  hour12Img.src = `/src/images/${hour12ImgSrc}.svg`
  hour13Img.src = `/src/images/${hour13ImgSrc}.svg`
  hour14Img.src = `/src/images/${hour14ImgSrc}.svg`
  hour15Img.src = `/src/images/${hour15ImgSrc}.svg`
  hour16Img.src = `/src/images/${hour16ImgSrc}.svg`
  hour17Img.src = `/src/images/${hour17ImgSrc}.svg`
  hour18Img.src = `/src/images/${hour18ImgSrc}.svg`
  hour19Img.src = `/src/images/${hour19ImgSrc}.svg`
  hour20Img.src = `/src/images/${hour20ImgSrc}.svg`
  hour21Img.src = `/src/images/${hour21ImgSrc}.svg`
  hour22Img.src = `/src/images/${hour22ImgSrc}.svg`
  hour23Img.src = `/src/images/${hour23ImgSrc}.svg`
